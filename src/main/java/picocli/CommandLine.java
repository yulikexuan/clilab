...
public class CommandLine {
     ...
     * <a href="https://docs.oracle.com/javase/8/docs/api/java/util/function/package-summary.html">functional interface</a>
     * whose functional method is {@link IParseResultHandler2#handleParseResult(ParseResult)}.
     * <p>
    ...
    public static abstract class AbstractHandler<R, T extends AbstractHandler<R, T>> {
        ...
        /**
         * Returns the ANSI style to use. Defaults to {@code Help.Ansi.AUTO}, unless {@link #useAnsi(Help.Ansi)} was called with a different setting.
         */
     ...
     * {@link #handle(ParseResult)} with the parse result. Facilitates implementation of the {@link IParseResultHandler2} interface.
    ...
    public abstract static class AbstractParseResultHandler<R> extends AbstractHandler<R, AbstractParseResultHandler<R>> implements IParseResultHandler2<R> {
        /**
         * Prints help if requested, and otherwise calls {@link #handle(ParseResult)}.
    ...
    private static StringBuilder usage(StringBuilder sb, Help help) {
        return sb.append(help.headerHeading()).append(help.header()).append(help.synopsisHeading())      //e.g. Usage:
    ...
    public static class Range implements Comparable<Range> {
        ...
        public static Range defaultArity(Field field) {
            ...
            if (field.isAnnotationPresent(Option.class)) {
                Class<?>[] typeAttribute = ArgsReflection.inferTypes(type, field.getAnnotation(Option.class).type(), field.getGenericType());
    ...
    public static final class Model {
        ...
        public static class CommandSpec {
            ...
            public CommandSpec usageMessage(UsageMessageSpec settings) {
                usageMessage.initFrom(settings);
                return this;
            }
            ...
            public String qualifiedName() {
                String result = name();
                if (parent() != null) {
                    result = parent().qualifiedName() + " " + result;
                }
                return result;
            }
            ...
            public CommandSpec mixinStandardHelpOptions(boolean newValue) {
                if (newValue) {
                    addMixin(AutoHelpMixin.KEY, CommandSpec.forAnnotatedObject(new AutoHelpMixin(), new DefaultFactory()));
                } else {
        ...
        public static class UsageMessageSpec {
            ...
            public String headerHeading() {
                return headerHeading == null ? DEFAULT_SINGLE_VALUE : headerHeading;
            }
            ...
            public String[] header() {
                return header == null ? DEFAULT_MULTI_LINE : header.clone();
            }
            ...
            public String synopsisHeading() {
                return (synopsisHeading == null) ? DEFAULT_SYNOPSIS_HEADING : synopsisHeading;
            }
            ...
            public String[] customSynopsis() {
                return customSynopsis == null ? DEFAULT_MULTI_LINE : customSynopsis.clone();
            }
            ...
            public String descriptionHeading() {
                return descriptionHeading == null ? DEFAULT_SINGLE_VALUE : descriptionHeading;
            }
            ...
            public String[] description() {
                return description == null ? DEFAULT_MULTI_LINE : description.clone();
            }
            ...
            public String parameterListHeading() {
                return parameterListHeading == null ? DEFAULT_SINGLE_VALUE : parameterListHeading;
            }
            ...
            public String optionListHeading() {
                return optionListHeading == null ? DEFAULT_SINGLE_VALUE : optionListHeading;
            }
            ...
            public String commandListHeading() {
                return (commandListHeading == null) ? DEFAULT_COMMAND_LIST_HEADING : commandListHeading;
            }
            ...
            public String footerHeading() {
                return footerHeading == null ? DEFAULT_SINGLE_VALUE : footerHeading;
            }
            ...
            public String[] footer() {
                return footer == null ? DEFAULT_MULTI_LINE : footer.clone();
            }
            ...
            void initSynopsisHeading(String value) {
                if (initializable(synopsisHeading, value, DEFAULT_SYNOPSIS_HEADING)) {
                    synopsisHeading = value;
                }
            }

            void initCommandListHeading(String value) {
                if (initializable(commandListHeading, value, DEFAULT_COMMAND_LIST_HEADING)) {
                    commandListHeading = value;
                }
            }

            void initRequiredOptionMarker(char value) {
                if (initializable(requiredOptionMarker, value, DEFAULT_REQUIRED_OPTION_MARKER)) {
                    requiredOptionMarker = value;
                }
            }

            void initAbbreviateSynopsis(boolean value) {
                if (initializable(abbreviateSynopsis, value, DEFAULT_ABBREVIATE_SYNOPSIS)) {
                    abbreviateSynopsis = value;
                }
            }

            void initSortOptions(boolean value) {
                if (initializable(sortOptions, value, DEFAULT_SORT_OPTIONS)) {
                    sortOptions = value;
                }
            }

            void initShowDefaultValues(boolean value) {
                if (initializable(showDefaultValues, value, DEFAULT_SHOW_DEFAULT_VALUES)) {
                    showDefaultValues = value;
                }
            }

            void initHidden(boolean value) {
                if (initializable(hidden, value, DEFAULT_HIDDEN)) {
                    hidden = value;
                }
            }

            void initCustomSynopsis(String[] value) {
                if (initializable(customSynopsis, value, DEFAULT_MULTI_LINE)) {
                    customSynopsis = value.clone();
                }
            }

            void initDescription(String[] value) {
                if (initializable(description, value, DEFAULT_MULTI_LINE)) {
                    description = value.clone();
                }
            }

            void initDescriptionHeading(String value) {
                if (initializable(descriptionHeading, value, DEFAULT_SINGLE_VALUE)) {
                    descriptionHeading = value;
                }
            }

            void initHeader(String[] value) {
                if (initializable(header, value, DEFAULT_MULTI_LINE)) {
                    header = value.clone();
                }
            }

            void initHeaderHeading(String value) {
                if (initializable(headerHeading, value, DEFAULT_SINGLE_VALUE)) {
                    headerHeading = value;
                }
            }

            void initFooter(String[] value) {
                if (initializable(footer, value, DEFAULT_MULTI_LINE)) {
                    footer = value.clone();
                }
            }

            void initFooterHeading(String value) {
                if (initializable(footerHeading, value, DEFAULT_SINGLE_VALUE)) {
                    footerHeading = value;
                }
            }

            void initParameterListHeading(String value) {
                if (initializable(parameterListHeading, value, DEFAULT_SINGLE_VALUE)) {
                    parameterListHeading = value;
                }
            }

            void initOptionListHeading(String value) {
                if (initializable(optionListHeading, value, DEFAULT_SINGLE_VALUE)) {
                    optionListHeading = value;
                }
            }
        ...
        public abstract static class ArgSpec {
            ...
            protected int hashCodeImpl() {
                return 17 + 37 * Assert.hashCode(defaultValue) + 37 * Assert.hashCode(type) + 37 * Assert.hashCode(arity) + 37 * Assert.hashCode(hidden) + 37 * Assert.hashCode(paramLabel) + 37 * Assert.hashCode(required) + 37 * Assert.hashCode(splitRegex) + 37 * Arrays.hashCode(description) + 37 * Arrays.hashCode(auxiliaryTypes);
            }
        ...
        public static class OptionSpec extends ArgSpec {
            ...
            public boolean equals(Object obj) {
                ...
                boolean result = super.equalsImpl(other) && help == other.help && usageHelp == other.usageHelp && versionHelp == other.versionHelp && new HashSet<String>(Arrays.asList(names)).equals(new HashSet<String>(Arrays.asList(other.names)));
                return result;
            }

            public int hashCode() {
                return super.hashCodeImpl() + 37 * Assert.hashCode(help) + 37 * Assert.hashCode(usageHelp) + 37 * Assert.hashCode(versionHelp) + 37 * Arrays.hashCode(names);
            }
        ...
        private static class CommandReflection {
            ...
            private static void validateArgSpecField(Field field) {
                ...
                if (Modifier.isFinal(field.getModifiers()) && (field.getType().isPrimitive() || String.class.isAssignableFrom(field.getType()))) {
                    throw new InitializationException("Constant (final) primitive and String fields like " + field + " cannot be used as " + (isOption(field) ? "an @Option" : "a @Parameter") + ": compile-time constant inlining may hide new values written to it.");
                }
            }
            ...
            static boolean isArgSpec(Field f) {
                return isOption(f) || isParameter(f);
            }
    ...
    private class Interpreter {
        ...
        private void parse(List<CommandLine> parsedCommands, Stack<String> argumentStack, String[] originalArgs) {
            ...
            if (!parseResult.unmatched.isEmpty()) {
                ...
                if (!isUnmatchedArgumentsAllowed()) {
                    throw new UnmatchedArgumentException(CommandLine.this, Collections.unmodifiableList(parseResult.unmatched));
                }
                if (tracer.isInfo()) {
        ...
        private void applyDefault(ArgSpec arg, List<ArgSpec> required) throws Exception {
            ...
            if (tracer.isDebug()) {
                tracer.debug("Applying defaultValue (%s) to %s%n", arg.defaultValue(), arg);
            }
        ...
        private void processArguments(List<CommandLine> parsedCommands, Stack<String> args, Collection<ArgSpec> required, Set<ArgSpec> initialized, String[] originalArgs) throws Exception {
            // arg must be one of:
        ...
        private boolean resemblesOption(String arg) {
            ...
            if (tracer.isDebug()) {
                tracer.debug("%s %s an option: %d matching prefix chars out of %d option names%n", arg, (result ? "resembles" : "doesn't resemble"), count, commandSpec.optionsMap().size());
            }
            return result;
        }
        ...
        private int applyValueToSingleValuedField(ArgSpec argSpec, Range arity, Stack<String> args, Set<ArgSpec> initialized, String argDescription) throws Exception {
        ...
        private int applyValuesToMapField(ArgSpec argSpec, Range arity, Stack<String> args, Set<ArgSpec> initialized, String argDescription) throws Exception {
        ...
        private void consumeMapArguments(ArgSpec argSpec, Range arity, Stack<String> args, Class<?>[] classes, ITypeConverter<?> keyConverter, ITypeConverter<?> valueConverter, Map<Object, Object> result, String argDescription) throws Exception {
        ...
        private void consumeOneMapArgument(ArgSpec argSpec, Range arity, int consumed, String arg, Class<?>[] classes, ITypeConverter<?> keyConverter, ITypeConverter<?> valueConverter, Map<Object, Object> result, int index, String argDescription) {
            String raw = trim(arg);
        ...
        private String[] splitKeyValue(ArgSpec argSpec, String value) {
            ...
            if (keyValue.length < 2) {
                ...
                if (splitRegex.length() == 0) {
                    throw new ParameterException(CommandLine.this, "Value for option " + optionDescription("", argSpec, 0) + " should be in KEY=VALUE format but was " + value);
                } else {
                    throw new ParameterException(CommandLine.this, "Value for option " + optionDescription("", argSpec, 0) + " should be in KEY=VALUE[" + splitRegex + "KEY=VALUE]... format but was " + value);
                }
            }
            return keyValue;
        }
        ...
        private int applyValuesToArrayField(ArgSpec argSpec, Range arity, Stack<String> args, Set<ArgSpec> initialized, String argDescription) throws Exception {
        ...
        @SuppressWarnings("unchecked")
        private int applyValuesToCollectionField(ArgSpec argSpec, Range arity, Stack<String> args, Set<ArgSpec> initialized, String argDescription) throws Exception {
        ...
        private List<Object> consumeArguments(ArgSpec argSpec, Range arity, Stack<String> args, Class<?> type, String argDescription) throws Exception {
            List<Object> result = new ArrayList<Object>();
        ...
        private int consumeOneArgument(ArgSpec argSpec, Range arity, int consumed, String arg, Class<?> type, List<Object> result, int index, String argDescription) {
            String raw = trim(arg);
            String[] values = argSpec.splitValue(raw, commandSpec.parser(), arity, consumed);
        ...
        private void assertNoMissingParameters(ArgSpec argSpec, Range arity, Stack<String> args) {
            ...
            if (arity.min > available) {
                if (arity.min == 1) {
                    if (argSpec.isOption()) {
                        throw new MissingParameterException(CommandLine.this, argSpec, "Missing required parameter for " + optionDescription("", argSpec, 0));
                    }
                ...
                if (args.isEmpty()) {
                    throw new MissingParameterException(CommandLine.this, argSpec, optionDescription("", argSpec, 0) + " requires at least " + arity.min + " values, but none were specified.");
                }
                throw new MissingParameterException(CommandLine.this, argSpec, optionDescription("", argSpec, 0) + " requires at least " + arity.min + " values, but only " + available + " were specified: " + reverse(args));
            }
        }
     ...
     * {@link #init(CommandLine, Help.Ansi, PrintStream, PrintStream) init} method on commands marked as {@link Command#helpCommand() helpCommand}
    ...
    public static class Help {
         ...
         * @deprecated use {@link Help#Help(CommandSpec, ColorScheme)}
         */
        @Deprecated
        ...
        private Text appendOptionSynopsis(Text optionText, OptionSpec option, String optionName, String prefix, String suffix) {
            ...
            return optionText.concat(prefix).concat(colorScheme.optionText(optionName)).concat(optionParamText).concat(suffix);
        }
        ...
        public String optionList() {
            Comparator<OptionSpec> sortOrder = commandSpec.usageMessage().sortOptions() ? createShortOptionNameComparator() : null;
         ...
         * then {@linkplain Layout#addOption(OptionSpec, IParamLabelRenderer) adds} all non-hidden options to the
        ...
        public String commandList() {
            ...
            TextTable textTable = TextTable.forColumns(ansi(), new Column(commandLength + 2, 2, Column.Overflow.SPAN), new Column(width() - (commandLength + 2), 2, Column.Overflow.WRAP));
        ...
        static class DefaultOptionRenderer implements IOptionRenderer {
            ...
            private Text[][] renderDescriptionLines(OptionSpec option, ColorScheme scheme, String requiredOption, String shortOption, Text longOptionText) {
                ...
                result.add(new Text[]{scheme.optionText(requiredOption), scheme.optionText(shortOption), scheme.ansi().new Text(sep), longOptionText, descriptionFirstLines[0]});
        ...
        static class MinimalOptionRenderer implements IOptionRenderer {
            public Text[][] render(OptionSpec option, IParamLabelRenderer parameterLabelRenderer, ColorScheme scheme) {
                ...
                return new Text[][]{{optionText, scheme.ansi().new Text(option.description().length == 0 ? "" : option.description()[0])}};
            }
        }
        ...
        static class MinimalParameterRenderer implements IParameterRenderer {
            public Text[][] render(PositionalParamSpec param, IParamLabelRenderer parameterLabelRenderer, ColorScheme scheme) {
                return new Text[][]{{parameterLabelRenderer.renderParameterLabel(param, scheme.ansi(), scheme.parameterStyles), scheme.ansi().new Text(param.description().length == 0 ? "" : param.description()[0])}};
            }
        }
        ...
        public static class Layout {
            ...
            /**
             * Calls {@link #addOption(OptionSpec, IParamLabelRenderer)} for all non-hidden Options in the list.
             *
            ...
            /**
             * Calls {@link #addPositionalParameter(PositionalParamSpec, IParamLabelRenderer)} for all non-hidden Parameters in the list.
             *
        ...
        public static class ColorScheme {
             ...
             * </ul><p>Property values can be anything that {@link Style#parse(String)} can handle.</p>
             *
    ...
    /**
     * Base class of all exceptions thrown by {@code CommandLine}.
     *
     * @since 2.0
     */
